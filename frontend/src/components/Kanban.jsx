            ...
            <div className="cards-container">
              {col.lista.map(t => {
                ...
                if (t.subtarefas && t.subtarefas.length > 0) {
                  const concluidas = t.subtarefas.filter(sub => sub.concluida).length;
                  progressoCalculado = Math.round((concluidas / t.subtarefas.length) * 100);
                ...
                return (
                  ...
                  >
                    ...
                    {/* BARRA DE PROGRESSO COM O VALOR CALCULADO */}
                    ...
                    <div className="progress-bar-bg">
                      <div style={{
                        ...
                        backgroundColor: progressoCalculado === 100 ? '#15803D' : '#22C55E',
                        height: '100%',
